...
echo_and_run cd "/home/user/catkin_ws/src/robot_navigation/robot_nav_tools/rqt_dwb_plugin"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/user/catkin_ws/src/robot_navigation/robot_nav_tools/rqt_dwb_plugin/setup.py" \
     \
    build --build-base "/home/user/catkin_ws/build/robot_navigation/robot_nav_tools/rqt_dwb_plugin" \
    install \
    --root="${DESTDIR-/}" \
