...
struct BMSData_
{
  ...
  _cell_voltage_diff_type cell_voltage_diff;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _WST_serial_type;
  ...
  _SBS_battery_status_raw_type SBS_battery_status_raw;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _SBS_serial_1_type;
  _SBS_serial_1_type SBS_serial_1;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _SBS_serial_2_type;
...
struct Printer< ::mir_msgs::BMSData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mir_msgs::BMSData_<ContainerAllocator>& v)
  {
    ...
    s << indent << "WST_serial: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.WST_serial);
    s << indent << "bmz_flag: ";
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.SBS_serial_1);
    s << indent << "SBS_serial_2: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.SBS_serial_2);
